...
export default function Home() {
  return (
    <main>
      <div className="flex flex-col items-center justify-center pt-20 px-12 lg:p-24">
        ...
        <div className="hero bg-[#A3B18A] rounded-lg text-[#344E41] mt-7 max-w-7xl">
          <div className="hero-content flex-col lg:flex-row-reverse">
            <Image src={houston} className="w-fill md:w-72 lg:w-96 rounded-lg shadow-2xl" />
            <div>
      ...
      <div id="test" className="flex min-h-screen flex-col items-center justify-between pt-6 px-12 lg:p-24">
        <div className="hero bg-[#A3B18A] rounded-lg text-[#344E41] max-w-7xl">
          <div className="hero-content flex-col lg:flex-row-reverse">
            <Image src={houston} className="w-fill md:w-72 lg:w-96 rounded-lg shadow-2xl" />
            <div>
