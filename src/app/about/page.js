                ...
                <div className="hero-content flex-col lg:flex-row">
                    <div>
                        ...
                        <ul className="mt-10 timeline text-xs timeline-vertical justify-center lg:text-lg lg:timeline-horizontal lg:mt-1">
                            ...
                            <li>
                                <hr />
                                <div className="timeline-start lg:text-2xl font-bold text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">2021</div>
                                <div className="timeline-middle">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
                                </div>
                                <div className="timeline-end timeline-box bg-[#582f0e] text-white">UTA at GMU</div>
                                <hr />
                            </li>
                            <li>
                                <hr />
                                ...
                                <div className="timeline-end timeline-box bg-[#582f0e] text-white">Graduated from GMU</div>
                                <div className="mt-24 timeline-end timeline-box bg-[#582f0e] text-white lg:mt-14">Internship @ KnackWorks</div>
                                <hr />
                            </li>
                            <li>
                                <hr />
                                <div className="timeline-start lg:text-2xl font-bold text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">2023</div>
                                <div className="timeline-middle">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
                                </div>
                                <div className="timeline-end timeline-box bg-[#582f0e] text-white">Software Developer @ Freddie Mac</div>
                                <hr />
                            </li>
                            <li>
                                <hr />
                                ...
                                <div className="timeline-end timeline-box bg-[#582f0e] text-white">????</div>
                            </li>
                        </ul>
